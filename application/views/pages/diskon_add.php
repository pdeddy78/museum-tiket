        ...
        <div class="floatingBox">
            <div class="container-fluid">
                <?php
                    ...
                    echo form_open('Diskon/tambah', $attributes);
                ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="nama_diskon" value="<?=set_value('nama_diskon')?>" class="span10">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="keterangan" value="<?=set_value('keterangan')?>" class="span10">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="diskon" value="<?=set_value('diskon')?>" class="span2"> %
