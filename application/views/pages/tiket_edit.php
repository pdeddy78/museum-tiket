...
<div class="row-fluid">
    ...
    <div class="span8">
        <div class="containerHeadline">
            <i class="icon-ticket"></i><h2>Edit Jenis Tiket</h2>
        ...
        <div class="floatingBox">
            <div class="container-fluid">
                <?php
                    ...
                    echo form_open('tiket/edit/'.$id_tiket, $attributes);
                ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="nama_tiket" value="<?=$nama_tiket?>" class="span10">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="harga" value="<?=$harga?>" class="span10">
